    ...
    <div class="row">
        <div class="col-12">
            ...
            >
                ...
                <div class="media-body pb-1 mb-0 lh-125">
                    <div class="d-flex justify-content-between align-items-center w-100">
                        <a href="#" class="text-muted"><strong class="text-gray-dark">Nguyễn Văn A</strong></a>
            ...
            >
                ...
                <div class="media-body pb-1 mb-0 lh-125">
                    <div class="d-flex justify-content-between align-items-center w-100">
                        <strong class="text-gray-dark">Trần Văn B</strong>
            ...
            >
                ...
                <div class="media-body pb-1 mb-0 lh-125">
                    <div class="d-flex justify-content-between align-items-center w-100">
                        <strong class="text-gray-dark">Đào C</strong>
                        <i class="fas fa-circle small"></i>
                    </div>
            ...
            >
                ...
                <div class="media-body pb-1 mb-0 lh-125">
                    <div class="d-flex justify-content-between align-items-center w-100">
                        <strong class="text-gray-dark">Phạm D</strong>
                        <i class="fas fa-circle small"></i>
                    </div>
