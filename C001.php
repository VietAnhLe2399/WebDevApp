            ...
            <div class="row">
                <div id="left-content" class="col-2 border-right p-0 pt-4">
                    <div class="list-group list-group-flush">
                        ...
                        <?php 
                            if($_SESSION['role_user'] == "admin" || $_SESSION['role_user'] == "moderator") {
                                echo "<a href='admin.php' class='list-group-item list-group-item-action p-3 pl-4' style='border: none'>Trang quản lý</a>";
                            }
                        ?>
                        <a href="B008.php" class="list-group-item list-group-item-action p-3 pl-4" style="border: none">Khảo sát</a>
